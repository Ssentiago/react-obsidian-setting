...
const ReactObsidianSetting = ({ name, desc, setHeading, setDisabled, noBorder, class: className, addToggles, addTexts, addTextAreas, addMomentFormats, addDropdowns, addSearches, addButtons, addExtraButtons, addSliders, addColorPickers, addProgressBars, addMultiDesc, setupSettingManually, }) => {
    const settingRef = r.useRef();
